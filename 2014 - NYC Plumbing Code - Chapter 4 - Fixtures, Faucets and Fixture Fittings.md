...
### **402.2 Materials for Specialty Fixtures**
...
| 5       | Institutional          | I-3                                                          | Reformatories, detention centers and correctional centers    | 1 per 15                                                     | 1 per 15                                                     | 1 per 15                        | 1 per 15                                 | 1 per 15                                                     | 1 per 100                                                    | 1 service sink                                               |
...
**Section 403.1.3 was added by: [Local Law 79 of 2016](http://www1.nyc.gov/assets/buildings/local_laws/ll79of2016.pdf). This law has an effective date of October 26, 2016.*
...
Exception: The overflow from a [flush tank](https://up.codes/viewer/new_york_city/nyc-plumbing-code-2014/chapter/2/definitions#flush_tank) serving a [water](https://up.codes/viewer/new_york_city/nyc-plumbing-code-2014/chapter/2/definitions#water) closet or urinal shall discharge into the fixture served.
...
A 4-inch by 3-inch (102 mm by 76 mm) closet bend shall be acceptable. Where a 3-inch (76 mm) bend is utilized on [water](https://up.codes/viewer/new_york_city/nyc-plumbing-code-2014/chapter/2/definitions#water) closets, a 4-inch by 3-inch (102 mm by 76 mm) flange shall be installed to receive the fixture horn.
...
All [flush tanks](https://up.codes/viewer/new_york_city/nyc-plumbing-code-2014/chapter/2/definitions#flush_tank) shall be equipped with an [antisiphon](https://up.codes/viewer/new_york_city/nyc-plumbing-code-2014/chapter/2/definitions#antisiphon) [fill valve](https://up.codes/viewer/new_york_city/nyc-plumbing-code-2014/chapter/2/definitions#fill_valve) conforming to ASSE 1002 or CSA B125. The [fill valve](https://up.codes/viewer/new_york_city/nyc-plumbing-code-2014/chapter/2/definitions#fill_valve) [backflow preventer](https://up.codes/viewer/new_york_city/nyc-plumbing-code-2014/chapter/2/definitions#backflow_preventer) shall be located at least 1 inch (25 mm) above the full opening of the overflow pipe.



#### **425.3.2 Overflows in Flush Tanks**

[Flush tanks](https://up.codes/viewer/new_york_city/nyc-plumbing-code-2014/chapter/2/definitions#flush_tank) shall be provided with overflows discharging to the [water](https://up.codes/viewer/new_york_city/nyc-plumbing-code-2014/chapter/2/definitions#water) closet or urinal connected thereto and shall be sized to prevent flooding the tank at the maximum rate at which the tanks are supplied with [water](https://up.codes/viewer/new_york_city/nyc-plumbing-code-2014/chapter/2/definitions#water) according to the manufacturer's design conditions. The opening of the overflow pipe shall be located above the [flood level rim](https://up.codes/viewer/new_york_city/nyc-plumbing-code-2014/chapter/2/definitions#flood_level_rim) of the [water](https://up.codes/viewer/new_york_city/nyc-plumbing-code-2014/chapter/2/definitions#water) closet or urinal or above a secondary overflow in the [flush tank](https://up.codes/viewer/new_york_city/nyc-plumbing-code-2014/chapter/2/definitions#flush_tank).



#### **425.3.3 Sheet Copper**

Sheet copper utilized for [flush tank](https://up.codes/viewer/new_york_city/nyc-plumbing-code-2014/chapter/2/definitions#flush_tank) linings shall conform to ASTM B 152 and shall not weigh less than 10 ounces per square foot (0.03 kg/m2).



#### **425.3.4 Access Required**

All parts in a [flush tank](https://up.codes/viewer/new_york_city/nyc-plumbing-code-2014/chapter/2/definitions#flush_tank) shall be accessible for repair and replacement.
...
[Sanitary](https://up.codes/viewer/new_york_city/nyc-plumbing-code-2014/chapter/2/definitions#sanitary) floor sinks shall conform to the requirements of ASME A112.6.7.



## **Section 428 Prohibited Water Uses**

### **428.1 Prohibited Potable Water Uses**

[Potable water](https://up.codes/viewer/new_york_city/nyc-plumbing-code-2014/chapter/2/definitions#potable_water) shall not be permitted for those uses prohibited by this section.



#### **428.1.1 Potable Water Prohibited for Once Through Cooling**

[Potable water](https://up.codes/viewer/new_york_city/nyc-plumbing-code-2014/chapter/2/definitions#potable_water) shall not be used for [once-through cooling](https://up.codes/viewer/new_york_city/nyc-plumbing-code-2014/chapter/2/definitions#once-through_cooling). Equipment such as ice making machines, walk-in coolers, refrigerated walk-in boxes, or air conditioning equipment shall be provided with air cooled condensers or recirculating condenser [water](https://up.codes/viewer/new_york_city/nyc-plumbing-code-2014/chapter/2/definitions#water) systems, or supplied with non-potable as permitted by Appendix C of this code.

**Exceptions:**

1. Once-through [water](https://up.codes/viewer/new_york_city/nyc-plumbing-code-2014/chapter/2/definitions#water)-cooled ice making machines producing less than 500 pounds (227 kg) of ice per day at Standard Rating Conditions as specified in ARI 810.
2. Once-through [water](https://up.codes/viewer/new_york_city/nyc-plumbing-code-2014/chapter/2/definitions#water)-cooled ice making machines, walk-in coolers, refrigerated walk-in boxes or air conditioning equipment supplied with [potable water](https://up.codes/viewer/new_york_city/nyc-plumbing-code-2014/chapter/2/definitions#potable_water) through piping systems installed prior to January 1, 2011 and any subsequent replacements that use the same or lesser amount of [potable water](https://up.codes/viewer/new_york_city/nyc-plumbing-code-2014/chapter/2/definitions#potable_water).



## **Section 429 Rooftop Gardens and Landscaping**

### **429.1 Water Supply**

Where a connection to an approved [water](https://up.codes/viewer/new_york_city/nyc-plumbing-code-2014/chapter/2/definitions#water) supply is required by Section 318.5 of the *[New York City Fire Code](https://up.codes/viewer/new_york_city/nyc-fire-code-2014)* for rooftop gardens or landscaping exceeding 250 square feet (23 m2), an approved fixture shall be provided for connection to such [water](https://up.codes/viewer/new_york_city/nyc-plumbing-code-2014/chapter/2/definitions#water) supply in accordance with this code.